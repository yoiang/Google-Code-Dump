...
template <class LLType>
void LinkedList<LLType>::AddFront(LLType *pAdd)
{
...
template <class LLType>
void LinkedList<LLType>::AddBack(LLType *pAdd)
{
	LinkedListNode<LLType> *pNew = new LinkedListNode<LLType> ;
	pNew->pValue = pAdd ;
	if (pHead == 0)
...
template <class LLType>
void LinkedList<LLType>::Remove(LinkedListNode<LLType> *pRemove, bool bDeleteValue)
{
...
template <class LLType>
void LinkedList<LLType>::Clear(bool bDeleteValue)
{
	if (pHead == 0) return ;
